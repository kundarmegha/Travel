...
if(isset($_POST[update]))
{
   ...
   $update = $obj->update_data($table_name,$form_data,$table_id,$username);

//    $field=array('status');
//    $where="username";
//    $obj->getdata($table_name,$field,$where,$username);
 ...
 if (!(preg_match("/^(spec)[0-9]{3}$/i", $seid)))
{
 ...
 $field = array("username","firstname","lastname","email","dob","address");
require_once('dbFunc.php');
$obj = new dbFunc();
$table='profile';
    ...
    <section class="col-md-7 col-md-offset-1">
      <div class="find text-center">
       ...
       <input type="text" name="seid" class="text-center"  <?php
        ...
        {
            echo "placeholder='Enter the username'";
        }
       ?> required>
