...
trait FunctionalTestSetupTrait {
  ...
  protected function prepareRequestForGenerator($clean_urls = TRUE, $override_server_vars = []) {
    ...
    if ($clean_urls) {
      ...
      $request_path = $base_path ? $base_path . '/index.html/user' : '/index.html/user';
    }
  ...
  protected function setupBaseUrl() {
    ...
    $_SERVER['SCRIPT_NAME'] = $path . '/index.html';
    $_SERVER['SCRIPT_FILENAME'] = $path . '/index.html';
    $_SERVER['PHP_SELF'] = $path . '/index.html';
